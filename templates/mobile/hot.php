...
<div class="m-post-list">
    ...
    <div class="m-empty">
        ...
        <div class="m-empty-text">暂无热门内容</div>
    </div>
    <?php else: ?>
    ...
    <div class="m-post-item" data-id="<?php echo $post['id']; ?>">
        <div class="m-post-header">
            ...
            <div class="m-post-user-info">
                ...
                <div class="m-post-time"><?php echo $post['time_ago']; ?></div>
            </div>
        </div>
...
<div class="m-load-more">
    <a href="<?php echo $this->url('mobile/hot?page=' . ($page + 1)); ?>" style="color:var(--primary-color);text-decoration:none;">加载更多</a>
</div>
<?php endif; ?>
